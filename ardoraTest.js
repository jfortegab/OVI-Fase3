...
if (ima[indexTag].length>0){$("#ardoraChecks").css("width","75");
...
if ((mp4[indexTag].length>0)||(ogv[indexTag].length>0)){$("#ardoraChecks").css("width","75px");var newDiv=$('<div id="videoForTag"></div>);');
...
if ((ima[indexTag].length==0)&&(mp4[indexTag].length==0)&&(ogv[indexTag].length==0)){$("#ardoraChecks").css("width", "300px");}
